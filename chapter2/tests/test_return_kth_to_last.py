...
class TestReturnKthToLast(unittest.TestCase):
    def test_0th_to_last(self):
        ...
        self.assertIsNone(kth_to_last(head, 0))
    ...
    def test_last(self):
        ...
        head.next.next = Node(2)
        head.next.next.next = Node(3)
        self.assertEqual(head.next.next.next, kth_to_last(head, 1))
    ...
    def test_2nd_to_last(self):
        ...
        head.next.next = Node(2)
        head.next.next.next = Node(3)
        self.assertEqual(head.next.next, kth_to_last(head, 2))
    ...
    def test_3rd_to_last(self):
        ...
        head.next.next = Node(2)
        head.next.next.next = Node(3)
        self.assertEqual(head.next, kth_to_last(head, 3))
    ...
    def test_4th_to_last(self):
        ...
        head.next.next = Node(2)
        head.next.next.next = Node(3)
        self.assertEqual(head, kth_to_last(head, 4))
